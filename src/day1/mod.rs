...
pub fn solve_a() -> String {
    return total_adjustments(utility::load_adjustments("input1a.txt".to_string())).to_string();
}

pub fn solve_b() -> String {
    return stops_twice(utility::load_adjustments("input1a.txt".to_string())).to_string();
}
